...
public:
    ...
    struct boss_janalaiAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            // 激活火墙
            //if (GameObject* gate = instance->GetGameObject(GO_DOOR_ZULJIN))
            //{
            //    gate->SetGoState(GO_STATE_READY); // 设置门的状态为关闭
            //}
        ...
        //            if (i == 0 || i == 2) // 第1和第3方向
        //            {
        //                wall = me->SummonCreature(NPC_FIRE_BOMB,
        //                    FireWallCoords[i][0],
        //                    FireWallCoords[i][1] + 5 * (j - 2), // 调整y坐标偏移以生成5层
        //                    FireWallCoords[i][2],
        //                    FireWallCoords[i][3],
        ...
        //            {
        //                wall = me->SummonCreature(NPC_FIRE_BOMB,
        //                    FireWallCoords[i][0] - 8 + 4 * j, // 调整x坐标偏移以生成5层
        //                    FireWallCoords[i][1],
        //                    FireWallCoords[i][2],
        //                    FireWallCoords[i][3],
        //                    TEMPSUMMON_TIMED_DESPAWN,
