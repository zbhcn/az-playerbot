...
public:
    ...
    struct boss_zuljinAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            //激活火墙
            //if (GameObject* gate = me->GetMap()->GetGameObject(instance->GetGuidData(GO_DOOR_ZULJIN)))
        ...
        void JustEngagedWith(Unit* /*who*/) override
        {
            ...
            if (GameObject* gate = instance->GetGameObject(GO_DOOR_ZULJIN))
            {
                gate->SetGoState(GO_STATE_ACTIVE); // 设置门的状态为激活
            }
        }
        ...
        void JustDied(Unit* /*killer*/) override
        {
            ...
            if (GameObject* gate = instance->GetGameObject(GO_DOOR_ZULJIN))
            {
                gate->SetGoState(GO_STATE_ACTIVE); // 设置门的状态为关闭
            }
        }
